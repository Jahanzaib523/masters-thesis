...
export function Register() {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg transition-shadow hover:shadow-xl sm:p-8">
      ...
      {/* Type selector */}
      <div className="mt-6 flex gap-2 rounded-xl bg-slate-100 p-1.5" role="tablist" aria-label="Registration type">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-slate-700">Password (optional—you can add it later in Profile)</label>
          <input
            id="password"
            name="password"
            type="password"
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-4 transition-all duration-200">
          ...
          {type === 'text' && (
            <div>
              <label htmlFor="secret" className="block text-sm font-medium text-slate-700">Secret phrase (required, min 10 characters)</label>
              <textarea
                id="secret"
                required={type === 'text'}
                minLength={10}
